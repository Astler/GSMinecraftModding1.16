...
import mod.astler.tutorial_mod_gs.entity.ai.brain.task.AlarmAndPanicTask;
import mod.astler.tutorial_mod_gs.entity.ai.brain.task.RunAwayFromHurtHurtTask;
...
public class GSVillagerTasks {

    public static ImmutableList<Pair<Integer, ? extends Task<? super GSVillagerEntity>>> core(float p_220638_1_) {
        return ImmutableList.of(
                Pair.of(0, new SwimTask(0.8F)),
                Pair.of(0, new InteractWithDoorTask()),
                Pair.of(0, new LookTask(45, 90)),
                Pair.of(0, new AlarmAndPanicTask()),
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super GSVillagerEntity>>> panic(float p_220636_1_) {
        float f = p_220636_1_ * 1.5F;
        return ImmutableList.of(
                Pair.of(0, new RunAwayFromHurtHurtTask()),
                Pair.of(1, RunAwayTask.func_233965_b_(MemoryModuleType.NEAREST_HOSTILE, f, 6, false)),
                Pair.of(1, RunAwayTask.func_233965_b_(MemoryModuleType.HURT_BY_ENTITY, f, 6, false)),
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super GSVillagerEntity>>> work(float p_220639_1_) {
...
//        }
        ...
        return ImmutableList.of(
                ...
                Pair.of(5, new FirstShuffledTask<>(
                        ImmutableList.of(
                              //  Pair.of(spawngolemtask, 7),
                                Pair.of(new WorkTask(MemoryModuleType.JOB_SITE, 4), 2),
                                Pair.of(new WalkTowardsPosTask(MemoryModuleType.JOB_SITE, 1, 10), 5)
                                //Pair.of(new WalkTowardsRandomSecondaryPosTask(MemoryModuleType.SECONDARY_JOB_SITE, p_220639_1_, 1, 6, MemoryModuleType.JOB_SITE), 5)
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super GSVillagerEntity>>> idle(float walkingSpeed) {
        return ImmutableList.of(
                Pair.of(2, new FirstShuffledTask<>(ImmutableList.of(
                        ...
                        Pair.of(new InteractWithEntityTask<>(EntityType.VILLAGER, 8, AgeableEntity::canBreed, AgeableEntity::canBreed, MemoryModuleType.BREED_TARGET, walkingSpeed, 2), 1),
                        Pair.of(InteractWithEntityTask.func_220445_a(EntityType.CAT, 8, MemoryModuleType.INTERACTION_TARGET, walkingSpeed, 2), 1), Pair.of(new FindWalkTargetTask(walkingSpeed), 1),
                        Pair.of(new WalkTowardsLookTargetTask(walkingSpeed, 2), 1),
                        Pair.of(new JumpOnBedTask(walkingSpeed), 1),
...
//
    private static Pair<Integer, Task<LivingEntity>> lookAtMany() {
        return Pair.of(5, new FirstShuffledTask<>(ImmutableList.of(
                ...
                Pair.of(new LookAtEntityTask(EntityClassification.WATER_AMBIENT, 8.0F), 1),
